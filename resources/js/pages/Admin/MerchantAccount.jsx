...
import {
    ArrowLeftOutlined, CheckCircleOutlined, CloseCircleOutlined, FormOutlined,
...
export default function MerchantAccount() {
    ...
    const formColumns = [
        ...
        },
        {
            ...
            key: 'is_published',
            width: 100,
            render: (pub) => <Tag color={pub ? 'success' : 'default'}>{pub ? 'Published' : 'Draft'}</Tag>,
        },
        {
            title: 'Responses',
        ...
        },
        {
            ...
            width: 80,
            render: (_, record) => (
                <Button size="small" onClick={() => setSelectedForm(record)} style={{ borderRadius: 6 }}>View</Button>
            ),
        },
    ];
    ...
    return (
        <AdminLayout>
            ...
            <Header style={{ background: '#fff', padding: '0 24px', borderBottom: '1px solid #f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Space>
                    <Button icon={<ArrowLeftOutlined />} onClick={() => router.visit('/admin')} style={{ borderRadius: 8 }}>
                        Back
                    </Button>
                    ...
                    <Col xs={24} md={12}>
                        ...
                        >
                            <Descriptions column={1} size="small">
                                <Descriptions.Item label="Shop Domain"><Text strong>{merchant.name}</Text></Descriptions.Item>
                                ...
                                <Descriptions.Item label="Subscription">
                                    <Tag color={active ? 'success' : 'default'}>{merchant.subscription_status ?? 'None'}</Tag>
                                </Descriptions.Item>
